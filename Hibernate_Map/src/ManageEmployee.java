...
public class ManageEmployee {
   ...
   public static void main(String[] args) {
      ...
      set.put("ComputerScience", new Certificate(1, "MCA"));
      set.put("BusinessManagement", new Certificate(2, "MBA"));
      set.put("ProjectManagement", new Certificate(3, "PMP"));
